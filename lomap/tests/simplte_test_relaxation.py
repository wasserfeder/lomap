...
def fsa_constructor(task_case):
    ...
    specs = ['F B']  # canonical case

    # if task_case == '1':
    #     specs = ['F A'] #canonical case
    #
    # elif task_case == '2':
...
def ts_constructor():
    ...
    # ts.g.add_weighted_edges_from([(0,1,1),(0,0,1), (1,1,1), (1,2,1), (2,2,1), (2,3,1),(3,3,1), (3,4,1), (1,4,2)])
    # ts.g.add_weighted_edges_from([(0,1,1),(0,0,1), (1,1,1)])
    ts.g.add_weighted_edges_from([(0,0,1), (0,1,10),(0,2,1), (2,2,1), (1,1,1), (1,2,3), (2,1,3)])
